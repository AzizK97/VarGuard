...
echo "  - Watch clean-version branch → deploy to clean-version-ns"
echo "  - Watch azizTest branch → deploy to aziztest-ns"
echo "  - Watch hedi1 branch → deploy to hedi1-ns"
echo "  - Watch test branch → deploy to test-ns"
echo ""
echo "Check status:"
